...
const Clients = () => {
    ...
    return (
      <div className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {[...Array(3)].map((_, i) => (
            <Card key={i} className="hover-lift bg-gray-800 border-gray-700">
        ...
        <Card className="shadow-lg bg-gray-800 border-gray-700">
          <CardHeader className="bg-gray-700 rounded-t-lg border-b border-gray-600">
            <div className="flex justify-between items-center">
              ...
              <Skeleton className="h-10 w-64 bg-gray-600" />
            </div>
          </CardHeader>
          <CardContent className="p-0">
            <div className="space-y-4 p-6">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="flex items-center space-x-4 p-4 border border-gray-700 rounded-lg bg-gray-800">
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-4xl font-bold tracking-tight text-white">Clients</h1>
      ...
      {/* Stats Cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="hover-lift bg-gray-800 border-gray-700">
          <CardContent className="pt-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-medium text-blue-400">Total Clients</p>
        ...
        <Card className="hover-lift bg-gray-800 border-gray-700">
          <CardContent className="pt-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-medium text-green-400">Active Clients</p>
        ...
        <Card className="hover-lift bg-gray-800 border-gray-700">
          <CardContent className="pt-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-medium text-purple-400">New This Week</p>
                <p className="text-3xl font-bold text-white">{recentClients}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="shadow-lg bg-gray-800 border-gray-700">
        <CardHeader className="bg-gray-700 border-b border-gray-600">
          <div className="flex justify-between items-center">
            <div>
              <CardTitle className="text-xl text-white">Client Directory</CardTitle>
            ...
            <div className="relative w-72">
              ...
              <Input
                ...
                className="pl-10 h-12 text-base bg-gray-800 border-gray-600 text-white placeholder:text-gray-500"
              />
            </div>
          </div>
        </CardHeader>
              ...
              <Table>
                <TableHeader className="bg-gray-700">
                  <TableRow className="border-gray-600">
                    ...
                    <TableHead className="font-semibold text-gray-300">Age</TableHead>
                    <TableHead className="font-semibold text-gray-300">Gender</TableHead>
                    <TableHead className="font-semibold text-gray-300">Status</TableHead>
                    <TableHead className="font-semibold text-gray-300">Added</TableHead>
                    <TableHead className="w-[70px] font-semibold text-gray-300">Actions</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {filteredClients.map((client, index) => (
                    <TableRow key={client.id} className={index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-850 border-gray-700'}>
                      ...
                      <TableCell>
                        <Badge 
                          ...
                          className={client.is_active ? "bg-green-600 text-white border-green-500" : "bg-gray-600 text-gray-300 border-gray-500"}
                        >
