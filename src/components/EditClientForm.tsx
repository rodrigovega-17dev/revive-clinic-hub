      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-card border-border">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-t pt-4 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="edit_rfc" className="text-sm font-medium text-foreground">{t('clients.rfc')}</Label>
                <Input
                  id="edit_rfc"
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_cfdi_email" className="text-sm font-medium text-foreground">{t('clients.cfdiEmail')}</Label>
                <Input
                  id="edit_cfdi_email"
                  type="email"
                  placeholder={t('common.enterEmail')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="edit_tax_regime" className="text-sm font-medium text-foreground">{t('clients.taxRegime')}</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_cfdi_use" className="text-sm font-medium text-foreground">{t('clients.cfdiUse')}</Label>
