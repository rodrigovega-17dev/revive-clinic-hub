...
const runAgentLoop = async (clinicId, clinicName, clinicTimezone, historyMessages, dynamicRulesSnapshot) => {
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (therapistsError) {
      console.warn('ai-chat: therapists config snapshot unavailable:', therapistsError.message);
    }
    ...
    const { text, toolCallLog } = await runAgentLoop(clinicId, clinicName, clinicTimezone, history, dynamicRulesSnapshot);
